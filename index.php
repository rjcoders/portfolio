          ...
          <div class="art-info-bar-frame">
            ...
            <div class="art-header">
              ...
              <div class="art-avatar">
                <a data-fancybox="avatar" href="img/me.jpg" class="art-avatar-curtain">
                ...
                <div class="art-lamp-light">
                  ...
                  <div class="art-available-lamp" style="background: #10ff00;"></div>
                </div>
              </div>
              <!-- avatar end -->
              <!-- name -->
              <h5 class="art-name mb-10"><a href="index.php">Roshan Jha..!</a></h5>
              <!-- post -->
              <div class="art-sm-text">Web Deweloper And <br>Front-end Deweloper, </div>
            </div>
            <!-- info bar header end -->
            ...
            <div id="scrollbar2" class="art-scroll-frame">
              ...
              <div class="art-table p-15-15">
                ...
                <ul>
                  <!-- country -->
                  <li>
                    <h6>Residence:</h6><span>Nirman Vihar Delhi</span>
                  </li>
                  <!-- city -->
                  <li>
                    ...
                    <div class="art-a art-banner" style="background-image: url(img/bg.jpg)">
                      ...
                      <div class="art-banner-overlay">
                        ...
                        <div class="art-banner-title">
                          <!-- title -->
                          <h1 class="mb-15">We Are A Team Of Dedicated<br> 
                            <b style="color: #ffc107;">Developer's</b> &
                            <b style="color: #ffc107;"> Designer's</b></h1>
                          <!-- suptitle -->
                        ...
                        <!-- main title end -->
                        <!-- photo -->
                        <img src="img/face-6.png" class="art-banner-photo" alt="Your Name">
                      </div>
                      <!-- banner overlay end -->
                    </div>
                    <!-- banner end -->
                ...
                <div class="row p-30-0">
                  ...
                  <div class="col-md-3 col-6">
                    ...
                    <div class="art-counter-frame">
                      ...
                      <div class="art-counter-box">
                        <!-- counter number -->
                        <span class="art-counter">42</span>
                      </div>
                      <!-- counter end -->
                      <!-- title -->
